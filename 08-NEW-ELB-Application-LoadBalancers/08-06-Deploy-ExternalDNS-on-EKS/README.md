...
```
arn:aws:iam::914144875922:policy/AllowExternalDNSUpdates
...
eksctl create iamserviceaccount \
    ...
    --namespace default \
    --cluster eksdemo1 \
    --attach-policy-arn arn:aws:iam::914144875922:policy/AllowExternalDNSUpdates \
    --approve \
    --override-existing-serviceaccounts
```
...
```
arn:aws:iam::914144875922:role/eksctl-eksdemo1-addon-iamserviceaccount-defa-Role1-GNIEKY7VL6J4

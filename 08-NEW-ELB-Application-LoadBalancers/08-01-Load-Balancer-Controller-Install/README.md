...
` arn:aws:iam::914144875922:policy/AWSLoadBalancerControllerIAMPolicy `
...
eksctl create iamserviceaccount \
  --cluster=devopsclusters-default \
  --namespace=kube-system \
  --name=aws-load-balancer-controller \
  --attach-role-arn arn:aws:iam::788181305723:role/devopsclusters-default-aws-load-balancer-role  \
  --override-existing-serviceaccounts \
  --approve
  # --attach-policy-arn=arn:aws:iam::914144875922:policy/AWSLoadBalancerControllerIAMPolicy \
```
- **Sample Output**
```t
...
export VPC_ID=vpc-030ad349c1db1cfb2
...
# Sample Output
kube-system get svc aws-load-balancer-webhook-service

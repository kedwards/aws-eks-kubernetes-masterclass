...
```
AWS_MAIL_SERVER_HOST=email-smtp.us-west-2.amazonaws.com
AWS_MAIL_SERVER_USERNAME=****
AWS_MAIL_SERVER_PASSWORD=***
AWS_MAIL_SERVER_FROM_ADDRESS= it@connectusgobal.com
```
...
-  **Email Addresses**
    ...
    - **From Address:** kedwards@connectusglobal.com (replace with your ids during verification)
    - **To Address:** kedwards@kevinedwards.ca (replace with your ids during verification)
...
- Environment Variables
    ...
    - AWS_MAIL_SERVER_USERNAME=*****
    - AWS_MAIL_SERVER_PASSWORD=*****
    - AWS_MAIL_SERVER_FROM_ADDRESS=kedwards@connectusglobal.com

```
eks-micro-ses-smtp-user.20210915-065731
SMTP Username: AKIAQATH2EUZCZ2PQFM5
SMTP Password: BMfxmRIpXONEjaY/AFAygDFrdngCAawNlWqYvRHCuKQ9
```
...
```yml
          ...
          - name: AWS_MAIL_SERVER_USERNAME
            value: "AKIAQATH2EUZCZ2PQFM5"
          - name: AWS_MAIL_SERVER_PASSWORD
            value: "BMfxmRIpXONEjaY/AFAygDFrdngCAawNlWqYvRHCuKQ9"
          - name: AWS_MAIL_SERVER_FROM_ADDRESS
            value: "kedwards@connectusglobal.com"
```
...
spec:
  type: ExternalName
  externalName: email-smtp.us-west-2.amazonaws.com
```

...
- Go to Services -> VPC
- **VPC Name:**  eksctl-eksrtls1-cluster/VPC
...
- VPC: eksctl-eksrtls1-cluster/VPC
- **Inbound Rules**
  - Type: MySQL/Aurora
  - Protocol: TPC
  - Port: 3306
...
- Click on **Create DB Subnet Group**
  ...
  - **VPC:** eksctl-eksrls1-cluster/VPC
...
```
kubectl run -it --rm --image=mysql:5.7.22 --restart=Never mysql-client -- mysql -h usermgmtdb.cigplqoqggtj.us-west-2.rds.amazonaws.com -u dbadmin -pdbpassword11
